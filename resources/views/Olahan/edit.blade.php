        ...
        <nav class="navbar bg-body-tertiary" style="margin-bottom: 10px">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <span class="fw-bold">Edit Olahan </span>
                </a>
            </div>
        </nav>
        <form action="/olahan/{{ $olahan->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nama Olahan</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                    name="nama_olahan" value="{{ $olahan->nama_olahan }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deskripsi">{{ $olahan->deskripsi }}</textarea>
            </div>
            <div class="mb-3">
